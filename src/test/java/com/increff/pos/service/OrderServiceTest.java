...
//        orderService.addOrder(orderItems, order);
//        List<OrderItemPojo> items = orderService.selectItems(order.getId());
...
//        OrderItemPojo item2 = createOrderItem(product2,order2, 20, 200);
//        orderItems2.add(item2);
//        orderService.addOrder(orderItems2, order2);
//        List<OrderPojo> orders = orderService.selectOrders();
//        assertEquals(2, orders.size());
//        List<OrderItemPojo> items = orderService.selectItems(orders.get(0).getId());
//        assertEquals(1, items.size());
//        assertEquals(20, items.get(0).getQuantity());
//        assertEquals(200, items.get(0).getSellingPrice(), 0.001);
//        items = orderService.selectItems(orders.get(1).getId());
//        assertEquals(1, items.size());
//        assertEquals(10, items.get(0).getQuantity());
//        assertEquals(100, items.get(0).getSellingPrice(), 0.001);
//    }
...
//        orderItems2.add(item2);
//        orderService.addOrder(orderItems2, order2);
//        OrderPojo order3 = orderService.selectOrderById(order.getId());
//        assertEquals(order.getId(), order3.getId());
//        List<OrderItemPojo> items = orderService.selectItems(order3.getId());
//        assertEquals(1, items.size());
//        assertEquals(10, items.get(0).getQuantity());
//        assertEquals(100, items.get(0).getSellingPrice(), 0.001);
//        order3 = orderService.selectOrderById(order2.getId());
//        assertEquals(order2.getId(), order3.getId());
//        items = orderService.selectItems(order3.getId());
//        assertEquals(1, items.size());
//        assertEquals(20, items.get(0).getQuantity());
//        assertEquals(200, items.get(0).getSellingPrice(), 0.001);
//    }
//
////    @Test
////    public void testInsertInvoice() throws ApiException {
////        BrandPojo brand = createBrand("brand", "category");
////        brandService.add(brand);
////        ProductPojo product = createProduct(brand, "name", "barcode", 100);
////        ProductPojo product2 = createProduct(brand, "name2", "barcode2", 200);
...
////        orderItems.add(item2);
////        orderService.addItems(orderItems, order);
////        InvoicePojo invoice = createInvoice(order);
////        orderService.insertInvoice(invoice);
////        InvoicePojo invoice2 = orderService.selectInvoice(order.getId());
////        assertEquals(invoice.getInvoiceNumber(), invoice2.getInvoiceNumber());
////        assertEquals(invoice.getInvoiceDate(), invoice2.getInvoiceDate());
////        assertEquals(invoice.getInvoiceAmount(), invoice2.getInvoiceAmount(), 0.001);
////    }
//
//}
