        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="A4">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block>
                    <fo:inline>
                        <fo:external-graphic src="url(C:\Users\Shreyansh\Desktop\increff\employee-spring-full\src\main\resources\com\increff\pos\increff-logo1.png)" content-width="5.45cm" content-height="2.11cm"/>
                    </fo:inline>                         
                    </fo:block>
