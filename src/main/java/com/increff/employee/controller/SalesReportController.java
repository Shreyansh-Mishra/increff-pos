...
public class SalesReportController {
	...
	@ApiOperation(value="Get Sales Report By Brand and Category")
	@RequestMapping(path="/api/report/get-by-brand-category/{startDate}/{endDate}",method=RequestMethod.GET)
	public List<SalesByBrandAndCategoryData> getSalesByBrandAndCategory(@PathVariable String startDate, @PathVariable String endDate) throws ParseException{
		return salesReportFlow.getSalesByBrandAndCategory(startDate, endDate);
	}
	
	@ApiOperation(value="Get Inventory Report")
	@RequestMapping(path="/api/report/get-inventory",method=RequestMethod.GET)
