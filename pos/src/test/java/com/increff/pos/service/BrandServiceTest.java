...
public class BrandServiceTest extends AbstractUnitTest{
    ...
    public void testSelectByNameAndCategoryException() throws ApiException {
        BrandPojo brand = new BrandPojo();
        brand.setBrand("testbrand");
        brand.setCategory("testcategory");
        brandDao.insert(brand);
        service.selectByNameAndCategory("testbrand1","testcategory");
    }
    ...
    public void testGetByCategory(){
        ...
        brand2.setCategory("testcategory");
        brandDao.insert(brand2);
        List<BrandPojo> brands = service.getByCategory("testcategory");
        assertEquals(2,brands.size());
        assertEquals("testbrand",brands.get(0).getBrand());
        assertEquals("testcategory",brands.get(0).getCategory());
        assertEquals("testbrand2",brands.get(1).getBrand());
        assertEquals("testcategory",brands.get(1).getCategory());
    }
    ...
    public void testGetByName(){
        ...
        brand2.setCategory("testcategory2");
        brandDao.insert(brand2);
        List<BrandPojo> brands = service.getByName("testbrand");
        assertEquals(2,brands.size());
        assertEquals("testbrand",brands.get(0).getBrand());
        assertEquals("testcategory",brands.get(0).getCategory());
        assertEquals("testbrand",brands.get(1).getBrand());
        assertEquals("testcategory2",brands.get(1).getCategory());
    }
}
