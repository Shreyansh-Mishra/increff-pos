...
public class ReportDtoTest extends AbstractUnitTest {
    ...
    public void testBrandReport() throws ApiException {
        BrandPojo brand = createBrand("testbrand", "testcategory");
        BrandPojo brand2 = createBrand("testbrand2", "testcategory");
        BrandPojo brand3 = createBrand("testbrand", "testcategory3");
        brandDao.insert(brand);
        brandDao.insert(brand2);
        brandDao.insert(brand3);
        List<BrandReportData> brandReportData = reportDto.getBrandReport("all","all");
        assertEquals(3, brandReportData.size());
        assertEquals(brand.getBrand().toLowerCase(), brandReportData.get(0).getBrand());
        assertEquals(brand.getCategory().toLowerCase(), brandReportData.get(0).getCategory());
        assertEquals(brand2.getBrand().toLowerCase(), brandReportData.get(1).getBrand());
        assertEquals(brand2.getCategory().toLowerCase(), brandReportData.get(1).getCategory());
        assertEquals(brand3.getBrand().toLowerCase(), brandReportData.get(2).getBrand());
        assertEquals(brand3.getCategory().toLowerCase(), brandReportData.get(2).getCategory());
        brandReportData = reportDto.getBrandReport("all","testcategory");
        assertEquals(2, brandReportData.size());
        assertEquals(brand.getBrand().toLowerCase(), brandReportData.get(0).getBrand());
        assertEquals(brand.getCategory().toLowerCase(), brandReportData.get(0).getCategory());
        assertEquals(brand2.getBrand().toLowerCase(), brandReportData.get(1).getBrand());
        assertEquals(brand2.getCategory().toLowerCase(), brandReportData.get(1).getCategory());
        brandReportData = reportDto.getBrandReport("testbrand","all");
        assertEquals(2, brandReportData.size());
        assertEquals(brand.getBrand().toLowerCase(), brandReportData.get(0).getBrand());
        assertEquals(brand.getCategory().toLowerCase(), brandReportData.get(0).getCategory());
        assertEquals(brand3.getBrand().toLowerCase(), brandReportData.get(1).getBrand());
        assertEquals(brand3.getCategory().toLowerCase(), brandReportData.get(1).getCategory());
        brandReportData = reportDto.getBrandReport("testbrand","testcategory");
        assertEquals(1, brandReportData.size());
        assertEquals(brand.getBrand().toLowerCase(), brandReportData.get(0).getBrand());
        assertEquals(brand.getCategory().toLowerCase(), brandReportData.get(0).getCategory());
    }
